...
model_path = "core/removebg/model.onnx"
...
def predict(image_path):
    ...
    im_PIL.putalpha(matter)   # add alpha channel to keep transparency
    im_PIL.save('static/results/output.png')